			...
			<table>
				...
				<c:forEach items="${sellList}" var="sell">
					...
					<td><fmt:formatDate value="${sell.sdate}" dateStyle="short"/></td>
						<td><input type="text" id="sno_${sell.sno}" value="${sell.sno}" readonly></td><!-- 상세보기 -->
						<td>판매</td>
						<td><input type="text" id="pno_${sell.sno}" value="${sell.pno}" readonly></td>
						<td><input type="text" id="price_${sell.sno}" value="${sell.price}" readonly></td>
				...
				<button onclick="upcheckit()">통합수정</button>
			</table>
			<div id="page">
